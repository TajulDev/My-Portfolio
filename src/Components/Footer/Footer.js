        ...
        <div className='footer__section py-[20px] border-t-[1px] border-[#4c4a4a]'>
            <div className="container">
                <div className="footer__inner flex flex-col sm:flex-row sm:justify-between items-center">
                    ...
                    <p className='text-[#BCBBC8] text-[17px]'>Copyright © 2023 <span className='text-[#fff] font-[500] hover:text-[#72E2AE] cursor-pointer'>TAJUL DEVELOPER</span>. All rights reserved. </p>
                </div>
            </div>
        </div>
    );
